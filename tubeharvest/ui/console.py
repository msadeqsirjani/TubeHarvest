...
from rich.progress import (
    Progress, TaskID, BarColumn, TextColumn, DownloadColumn, 
...
class TubeHarvestUI:
 ...
 ╚══██╔══╝██║   ██║██╔══██╗██╔════╝    ██║  ██║██╔══██╗██╔══██╗██║   ██║██╔════╝██╔════╝╚══██╔══╝
    ...
    def interactive_setup(self) -> Dict[str, Any]:
        ...
        self.console.print("[bold yellow]📋 Let's configure your download settings![/]\n")
        ...
        try:
            ...
            config = {
                ...
                'quality': answers['quality'].replace('p', '') if answers['quality'] != 'best' else 'best',
                ...
                'filename': answers['filename'].strip() if answers['filename'].strip() else None,
    ...
    def show_config_summary(self, config: Dict[str, Any]):
        ...
        summary_table.add_row("📝 Subtitles", "✅ Yes" if config['subtitles'] else "❌ No")
        summary_table.add_row("📊 Metadata", "✅ Yes" if config['metadata'] else "❌ No")
    ...
    def start_download_session(self):
        ...
        self.console.print(Rule(title="[bold green]🚀 Starting Download Session[/]", style="green"))
        self.console.print()
        
    def add_download_task(self, description: str, total: Optional[int] = None) -> TaskID:
    ...
    def show_download_stats(self, total_downloads: int, failed_downloads: int, total_size: str = "Unknown"):
    ...
    def show_video_info(self, video_info: Dict[str, Any]):
        ...
        panel = Panel(
            info_table,
            title="[bold blue]🎬 Video Information[/]",
            border_style="blue"
        )
